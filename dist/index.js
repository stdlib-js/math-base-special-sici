"use strict";var n=function(r,e){return function(){try{return e||r((e={exports:{}}).exports,e),e.exports}catch(v){throw (e=0, v)}};};var N=n(function(m0,f){
...
var n0=require('@stdlib/math-base-assert-is-infinite/dist'),u0=require('@stdlib/math-base-assert-is-nan/dist'),B=require('@stdlib/math-base-special-cos/dist'),E=require('@stdlib/math-base-special-sin/dist'),a0=require('@stdlib/math-base-special-ln/dist'),y=require('@stdlib/constants-float64-half-pi/dist'),t0=require('@stdlib/constants-float64-eulergamma/dist'),v0=require('@stdlib/constants-float64-ninf/dist'),l0=N(),s0=F(),p0=g(),c0=I(),o0=M(),y0=m(),q0=H(),f0=O(),N0=R(),D0=b(),F0=j(),G0=w();function g0(r,e,v,u){var s,a,t,p,c,o,l,i;if(u0(r))return e[u]=NaN,e[u+v]=NaN,e;if(r<0?(s=-1,r=-r):s=0,r===0)return e[u]=0,e[u+v]=v0,e;if(r>1e9){if(n0(r))return s===-1?(a=-y,t=NaN):(a=y,t=0),e[u]=a,e[u+v]=t,e;a=y-B(r)/r,t=E(r)/r}return r>4?(l=E(r),p=B(r),i=1/(r*r),r<8?(c=l0(i)/(r*s0(i)),o=i*o0(i)/y0(i)):(c=p0(i)/(r*c0(i)),o=i*q0(i)/f0(i)),a=y-c*p-o*l,s&&(a=-a),t=c*l-o*p,e[u]=a,e[u+v]=t,e):(i=r*r,l=r*N0(i)/D0(i),p=i*F0(i)/G0(i),s&&(l=-l),a=l,t=t0+a0(r)+p,e[u]=a,e[u+v]=t,e)}J.exports=g0
